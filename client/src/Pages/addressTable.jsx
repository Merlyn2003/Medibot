...
// Fix for default marker icons not showing in React + Webpack
...
const AddressTable = () => {
  ...
  useEffect(() => {
    const overpassQuery = `[out:json];(
      node["amenity"~"hospital|clinic|doctors"](around:3000,13.0386,80.2072);
      way["amenity"~"hospital|clinic|doctors"](around:3000,13.0386,80.2072);
      relation["amenity"~"hospital|clinic|doctors"](around:3000,13.0386,80.2072);
    );out center;`;
